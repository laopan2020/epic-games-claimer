...
class EpicgamesClaimer:
    ...
    async def _login_async(self, email: str, password: str, verifacation_code: str = None, interactive: bool = True, remember_me: bool = True) -> None:
        ...
        if login_result == -1:
            raise TimeoutError("Check login result timed out")
        elif login_result == 0:
...
def login(cookies_path: str) -> None:
    ...
    claimer.navigate("https://www.epicgames.com/id/login?redirectUrl=https%3A%2F%2Fwww.epicgames.com%2Fstore", timeout=0)
